...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <!-- En-tête -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Publier une nouvelle offre</h1>
        <p class="text-gray-600">Créez une offre d'emploi ou de stage</p>
    </div>
    ...
    <div class="bg-white border border-gray-200 rounded p-8">
        <form action="{{ route('entreprise.offres.store') }}" method="POST">
                ...
                <div class="grid grid-cols-3 gap-4">
                    <label class="relative cursor-pointer">
                        <input 
                            ...
                            value="emploi" 
                            class="peer sr-only"
                            {{ old('type_offre', 'emploi') == 'emploi' ? 'checked' : '' }}
                            required
                    ...
                    <label class="relative cursor-pointer">
                        <input 
                            ...
                            class="peer sr-only"
                            {{ old('type_offre') == 'stage_professionnel' ? 'checked' : '' }}
                            onchange="toggleTypeContrat()"
                        >
                        <div class="border-2 border-gray-300 rounded p-4 text-center peer-checked:border-gray-900 peer-checked:bg-gray-50 hover:border-gray-400 transition">
                    ...
                    <label class="relative cursor-pointer">
                        <input 
                            ...
                            class="peer sr-only"
                            {{ old('type_offre') == 'stage_academique' ? 'checked' : '' }}
                            onchange="toggleTypeContrat()"
                        >
                        <div class="border-2 border-gray-300 rounded p-4 text-center peer-checked:border-gray-900 peer-checked:bg-gray-50 hover:border-gray-400 transition">
            ...
            <!-- Type de contrat (affiché uniquement pour emploi) -->
            ...
            <div class="mb-6">
                ...
                <input 
                    ...
                    value="{{ old('competences_requises') }}"
...
@push('scripts')
<script>
    // Toggle type de contrat selon type d'offre
    function toggleTypeContrat() {
        ...
        if (typeOffre === 'emploi') {
            ...
            typeContratSelect.value = 'stage';
        }
    }

    // Toggle champs salaire
