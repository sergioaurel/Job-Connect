...
@section('title', 'Publier une offre — Espace Entreprise')
...
<div class="bg-gray-950 border-b border-white/10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <h1 class="text-white font-extrabold text-2xl" style="letter-spacing:-0.02em">Publier une nouvelle offre</h1>
    </div>
</div>
            ...
            <form action="{{ route('entreprise.offres.store') }}" method="POST">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        @foreach([
                            ['value' => 'emploi',            'label' => 'Emploi',           'icon' => 'M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z', 'color' => 'indigo'],
                            ...
                            ['value' => 'stage_academique',  'label' => 'Stage académique', 'icon' => 'M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222', 'color' => 'orange'],
                        ] as $type)
                        <label class="relative cursor-pointer">
                            <input type="radio" name="type_offre" value="{{ $type['value'] }}"
                                   class="peer sr-only"
                                   {{ old('type_offre', 'emploi') == $type['value'] ? 'checked' : '' }}
                            ...
                            <div class="border-2 border-gray-200 rounded-xl p-4 text-center peer-checked:border-yellow-400 peer-checked:bg-yellow-50 hover:border-gray-300 transition-all">
                                <svg class="w-6 h-6 mx-auto mb-2 text-gray-400 peer-checked:text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select id="categorie_id" name="categorie_id" required
                                    ...
                                    @error('categorie_id') border-red-400 @enderror">
                    ...
                    {{-- Type de contrat (emploi uniquement) --}}
                    <div id="type_contrat_div">
                        ...
                        <select id="type_contrat" name="type_contrat"
                            ...
                            <option value="temps_partiel" {{ old('type_contrat') == 'temps_partiel' ? 'selected' : '' }}>Temps partiel</option>
                ...
                <div class="p-6 space-y-5">
                    ...
                    @foreach([
                        ['id' => 'description',     'label' => 'Description du poste',  'placeholder' => "Décrivez le poste, le contexte, l'environnement de travail...", 'required' => true],
                        ['id' => 'missions',         'label' => 'Missions principales',  'placeholder' => "- Mission 1\n- Mission 2\n- Mission 3",                         'required' => true],
                        ['id' => 'profil_recherche', 'label' => 'Profil recherché',      'placeholder' => "- Diplôme requis\n- Qualités recherchées\n- Savoir-être attendu",'required' => true],
                    ] as $field)
                    <div>
                        ...
                        <textarea id="{{ $field['id'] }}" name="{{ $field['id'] }}" rows="5"
                                  ...
                                  @error($field['id']) border-red-400 bg-red-50 @else border-gray-200 @enderror">{{ old($field['id']) }}</textarea>
                ...
                <div class="p-6 space-y-5">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" id="annees_experience" name="annees_experience" value="{{ old('annees_experience', 0) }}" min="0" required
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div id="salaire_fields" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" id="salaire_min" name="salaire_min" value="{{ old('salaire_min') }}" placeholder="150 000"
                                   class="w-full px-4 py-3 text-sm rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:bg-white focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/20 transition-all">
                        </div>
                        <div>
                            <label for="salaire_max" class="block text-sm font-semibold text-gray-700 mb-2">Salaire maximum (FCFA)</label>
                            <input type="number" id="salaire_max" name="salaire_max" value="{{ old('salaire_max') }}" placeholder="250 000"
                                   class="w-full px-4 py-3 text-sm rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:bg-white focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/20 transition-all">
                        </div>
                    </div>
                </div>
