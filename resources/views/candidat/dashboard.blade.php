...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8 rounded-2xl p-5 flex items-center gap-4 border border-yellow-400/30"
        ...
        <div class="flex-1 min-w-0">
            ...
            <p class="text-gray-600 text-xs mt-0.5">Un profil complet multiplie vos chances d'être contacté par les recruteurs.</p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden">
            ...
            <div class="divide-y divide-gray-50">
                ...
                $cfg = $statutConfig[$candidature->statut] ?? ['bg'=>'bg-gray-100','text'=>'text-gray-600','label'=>ucfirst($candidature->statut)];
                @endphp
                <div class="px-6 py-4 hover:bg-gray-50 transition-colors">
                    <div class="flex items-start justify-between gap-3">
                        <div class="flex-1 min-w-0">
                            <a href="{{ route('offres.show', $candidature->offre->slug) }}"
                               class="text-gray-900 font-bold text-sm hover:text-yellow-500 transition-colors block truncate">
                        ...
                        <span class="flex-shrink-0 px-2.5 py-1 text-xs font-extrabold rounded-lg {{ $cfg['bg'] }} {{ $cfg['text'] }}">
                            {{ $cfg['label'] }}
                        </span>
                    </div>
                </div>
                ...
                <div class="px-6 py-12 text-center">
                    ...
                    <p class="text-gray-400 text-xs mb-4">Commencez à postuler aux offres qui vous intéressent</p>
                    <a href="{{ route('offres.index') }}"
        ...
        <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden">
            ...
            <div class="divide-y divide-gray-50">
                ...
                <div class="px-6 py-4 hover:bg-gray-50 transition-colors group">
                    <div class="flex items-start justify-between gap-3">
                        ...
                        <a href="{{ route('candidat.candidatures.create', $offre->id) }}"
                           class="flex-shrink-0 px-3 py-1.5 bg-gray-100 text-gray-700 font-extrabold text-xs rounded-lg hover:bg-yellow-400 hover:text-gray-900 transition-all">
                            Postuler
                        </a>
                    </div>
                </div>
                ...
                <div class="px-6 py-12 text-center">
                    ...
                    <p class="text-gray-400 text-xs mb-4">Sauvegardez les offres qui vous intéressent</p>
                    <a href="{{ route('offres.index') }}"
                       class="inline-flex items-center gap-1.5 px-4 py-2 bg-gray-900 text-white font-extrabold text-xs rounded-xl hover:bg-yellow-400 hover:text-gray-900 transition-all">
